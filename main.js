...
function GameBoardAnimation(frames, x, y, frameHeight, frameWidth) {
    this.frames = frames;
    this.x = x;
    this.y = y;
...
function GameBoard(game) {
    ...
    this.animation = new GameBoardAnimation(animationFrames, this.x, this.y, frameHeight, frameWidth);
    Entity.call(this, game, this.x, this.y);
}
...
ASSET_MANAGER.downloadAll(function () {
	...
	var pwn2 = new Piece(gameEngine, "bishop", 1, 0, "white");
